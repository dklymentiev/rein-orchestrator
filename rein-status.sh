...
# Quick Rein Status - Show last 2 workflows (previous + latest)
...
echo -e "${CYAN}${BOLD}Rein Status - Last 2 Workflows${NC}"
echo -e "${CYAN}════════════════════════════════════════════════${NC}"
echo ""
...
echo -e "${CYAN}════════════════════════════════════════════════${NC}"
echo "For details:"
echo "  ./rein-history.sh 10         # Show history (last 10)"
echo "  ./rein-history.sh 10 latest  # Show latest details"
